...
\begin{remark}
Chris claims that the study of (1-dimensional) knots in the ``Whitehead manifold'' $W$ is nothing more than the study of knots in $\R^3$, even though $W$ is not homeomorphic to $\R^3$. Reasoning: due to $W$ being contractible, there is no ``topology'' to obstruct deforming the knot into a ``Euclidean patch'' sitting inside of $W$.
\end{remark}
